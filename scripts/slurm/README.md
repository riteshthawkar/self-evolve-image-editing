...
sbatch --export=ALL,TRAIN_MANIFEST=outputs/self_evolve/<run>/delta-ranker/round_03/train_manifest.json scripts/slurm/03_train_lora_from_manifest.sbatch
...
sbatch --export=ALL,LIMIT=128,SAMPLES_PER_PROPOSAL=2,MAX_RECORDS_PER_ROUND=128 scripts/slurm/02_self_evolve_delta_ranker.sbatch
```
